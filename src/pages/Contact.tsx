...
const Contact: React.FC = () => {
  ...
  const contactMethods = [
    ...
    },
    {
      ...
      title: 'Discord',
      value: 'henry_00_',
      link: 'https://discord.gg/RSBC5RnP',
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            {contactMethods.map((method, index) => (
              <motion.a
                ...
                className="group block p-8 bg-white/5 dark:bg-gray-900/20 backdrop-blur-md rounded-2xl shadow-lg border border-white/10 dark:border-gray-700/20 hover:shadow-xl hover:scale-1.05 transition-all duration-300"
              >
                <div
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {socialLinks.map((social, index) => (
              <motion.a
                ...
                className="group p-6 bg-white/5 dark:bg-gray-900/20 backdrop-blur-md rounded-2xl shadow-lg border border-white/10 dark:border-gray-700/20 hover:shadow-xl transition-all duration-300"
              >
        ...
        >
          ...
          <motion.a
            ...
            whileHover={{ scale: 1.05, boxShadow: '0 0 20px rgba(72,187,120,0.4)' }}
            whileTap={{ scale: 0.95 }}
